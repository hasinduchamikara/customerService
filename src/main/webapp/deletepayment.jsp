...
<h3> You Have Many Reasons for Choose US</h3>
	...
	<h2 id="new">User Payment Method Delete</h2>
	...
	<form action="deleteMethod" method="post">
		...
		<input type="text" name="pack" value="<%= pack%>" readonly><br>
		<label for="cno"><b>Card No</b></label>
		<input type="text" name="cno" value="<%= cardno%>" readonly><br>
		<label for="no"><b>CVC</b></label>
		<input type="text" name="no" value="<%= cvc%>" readonly><br>
		<label for="paymeth"><b>Payment Method</b></label>
		<input type="text" name="paymeth" value="<%= pmeth%>" readonly><br>
		
		<!-- <input type="submit" name="submit" value="Delete" style="font-size: large; border-radius: 5px; padding: 7px;"><br> -->
		<button type="submit" name="submit" style="font-size: large; border-radius: 5px; padding: 7px;">Delete</button>
	</form>
